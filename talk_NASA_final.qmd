...
footer: Modelling Summer Visit 2025 - NASA &nbsp;&nbsp; <img width="5%" src="figures/by-sa.png"/> &nbsp;&nbsp; Final presentation - August 1st 2025
 
---

:::{.row .text-center .align-items-center}
::::{.col}
![](figures/MSV2025-logo-text.png){height="90px"}
::::
::::{.col}
![](figures/logo_nasa.jpg){height="120px"}
::::
::::{.col}
![](figures/ESM-logo.png){height="100px"}
::::
::::{.col}
![](figures/logo.png){height="120px"}
::::
::::{.col}
![](figures/logo_polytechnique.png){height="90px"}
::::
:::
